        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <div className="relative">
            <p className="text-base md:text-xl lg:text-2xl text-amber-700 font-light tracking-[0.1em] md:tracking-[0.15em] uppercase">
              Est. 2024 • Vintage Photobooth Experience
            </p>
            <div className="absolute -top-1 md:-top-2 -right-2 md:-right-4 text-amber-600 text-xs md:text-sm rotate-12 font-bold animate-pulse">
              ★ RETRO ★
            </div>
          </div>
